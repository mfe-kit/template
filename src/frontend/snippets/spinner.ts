    ...
    <div class="${namespace}-spinner ${!isLoading ? namespace + '-hide' : ''}">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 200">
        <radialGradient id="a12" cx=".66" fx=".66" cy=".3125" fy=".3125" gradientTransform="scale(1.5)">
          ...
          <stop offset=".3" stop-color="#007bff" stop-opacity=".9"></stop>
          <stop offset=".6" stop-color="#007bff" stop-opacity=".6"></stop>
          <stop offset=".8" stop-color="#007bff" stop-opacity=".3"></stop>
